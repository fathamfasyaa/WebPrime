    ...
    <div class="container-fluid p-0">
        <div id="blog" class="row" style="padding-top: 80px">
            ...
            <div id="topweb" class="d-flex align-items-start px-5 pt-5 pb-5">
                ...
                <div class="text-primary fs-5 fw-normal">Website Development</div>
                <div class="text-secondary fs-5 fw-normal">/</div>
            </div>
            {{--    --}}
            <div id="app-development-section" class="d-flex align-items-start justify-content-start p-4">
                <div id="app-description" class="col-md-5 p-4 bg-white">
                    <p class="text-muted fs-4 font-open-sans">Website Development</p>
                    <h2 class="text-dark font-exo" style="font-size: 45px">Website Responsif dengan Performa dan Keamanan
                        Terbaik</h2>
                </div>
                <div id="app-details" class="col-md-5 bg-white" style="padding-left:300px ">
                    <p class="text-dark fs-3 font-exo text-wrap" style="width:800px">Kami menghadirkan website yang
                        fungsional, responsif, dan sesuai dengan branding Anda. Dari landing page hingga e-commerce, kami
                        pastikan setiap detail memenuhi ekspektasi dan memberikan pengalaman pengguna yang optimal.</p>
                </div>
            </div>
            {{--    --}}
            <div id="service-advantages-section" class="d-flex justify-content-start  bg-dark" style="height: 600px; ">
                <div id="service-description" class="col-md-5 d-flex flex-column gap-2">
                    ...
                    <p class="text-white fs-5 font-open-sans">
                        Di era digital, website yang kuat adalah kunci untuk meningkatkan visibilitas dan penjualan. Dengan
                        desain responsif dan SEO yang tepat, website Anda bisa menjadi alat utama untuk menarik dan mengubah
                        pengunjung menjadi pelanggan. Maka dari itu kami kami berkomitmen menawarkan layanana ektra untuk
                        bisnis Anda.
                    </p>
                </div>
                <div id="service-details" class="col-md-5 d-flex flex-column gap-3" style="padding-right: 600px !important">
                    <div class="service-feature gap-2 text-wrap" style="width: 800px">
                        <h3 class="text-white fs-4 font-exo" style="padding-top: 80px">Teknologi Terkini:</h3>
                        <p class="text-white fs-5 font-open-sans">
                            Kami menggunakan teknologi terbaru seperti React, Node.js, dan lainnya untuk memastikan website
                            Anda selalu up-to-date.
                        </p>
                    </div>
                    <div class="service-feature text-wrap"style="width: 800px">
                        <h3 class="text-white fs-4 font-exo">Desain Responsif:</h3>
                        <p class="text-white fs-5 font-open-sans">
                            Setiap website yang kami buat dioptimalkan untuk semua perangkat, memastikan pengalaman pengguna
                            yang sempurna.
                        </p>
                    </div>
                    <div class="service-feature text-wrap" style="width: 800px">
                        <h3 class="text-white fs-4 font-exo">
                            SEO Friendly:</h3>
                        <p class="text-white fs-5 font-open-sans">
                            Website Anda akan dirancang dengan praktik terbaik SEO untuk meningkatkan peringkat di mesin
                            pencari.
                        </p>
                    </div>
                    <div class="service-feature text-wrap" style="width: 800px">
                        <h3 class="text-white fs-4 font-exo">
                            Cocok Dengan Semua Kebutuhan</h3>
                        <p class="text-white fs-5 font-open-sans">
                            Kami membuat website yang disesuaikan dengan kebutuhan bisnis Anda saat ini dan mampu berkembang
                            untuk memenuhi kebutuhan bisnis Anda dimasadepan.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div id="process-content" class="d-flex flex-column align-items-start justify-content-start"
                    ...
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div id="design-development" class="process-card" style="padding-left: 300px">
                            ...
                            <div class="process-description text-wrap" style="width:700px">Tim dan mengembangkan website
                                dengan fokus pada user experience dan fungsionalitas.</div>
                        </div>
                    </div>
            ...
            <div id="portfolio-section" class="d-flex flex-column justify-content-start align-items-start bg-white">
                ...
                <div id="portfolio-heading" class="align-self-stretch text-dark fs-2 font-weight-medium">Webiste
                    Development</div>
            </div>
            {{--    --}}
